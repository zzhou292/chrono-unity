...
public class vector_Entry : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<DataDriverEntry>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          chrono_vehiclePINVOKE.delete_vector_Entry(swigCPtr);
        }
  ...
  public void Clear() {
    chrono_vehiclePINVOKE.vector_Entry_Clear(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(DataDriverEntry x) {
    chrono_vehiclePINVOKE.vector_Entry_Add(swigCPtr, DataDriverEntry.getCPtr(x));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = chrono_vehiclePINVOKE.vector_Entry_size(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = chrono_vehiclePINVOKE.vector_Entry_capacity(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    chrono_vehiclePINVOKE.vector_Entry_reserve(swigCPtr, n);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_Entry() : this(chrono_vehiclePINVOKE.new_vector_Entry__SWIG_0(), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_Entry(vector_Entry other) : this(chrono_vehiclePINVOKE.new_vector_Entry__SWIG_1(vector_Entry.getCPtr(other)), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_Entry(int capacity) : this(chrono_vehiclePINVOKE.new_vector_Entry__SWIG_2(capacity), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  private DataDriverEntry getitemcopy(int index) {
    DataDriverEntry ret = new DataDriverEntry(chrono_vehiclePINVOKE.vector_Entry_getitemcopy(swigCPtr, index), true);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private DataDriverEntry getitem(int index) {
    DataDriverEntry ret = new DataDriverEntry(chrono_vehiclePINVOKE.vector_Entry_getitem(swigCPtr, index), false);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, DataDriverEntry val) {
    chrono_vehiclePINVOKE.vector_Entry_setitem(swigCPtr, index, DataDriverEntry.getCPtr(val));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(vector_Entry values) {
    chrono_vehiclePINVOKE.vector_Entry_AddRange(swigCPtr, vector_Entry.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_Entry GetRange(int index, int count) {
    global::System.IntPtr cPtr = chrono_vehiclePINVOKE.vector_Entry_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, DataDriverEntry x) {
    chrono_vehiclePINVOKE.vector_Entry_Insert(swigCPtr, index, DataDriverEntry.getCPtr(x));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, vector_Entry values) {
    chrono_vehiclePINVOKE.vector_Entry_InsertRange(swigCPtr, index, vector_Entry.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    chrono_vehiclePINVOKE.vector_Entry_RemoveAt(swigCPtr, index);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    chrono_vehiclePINVOKE.vector_Entry_RemoveRange(swigCPtr, index, count);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public static vector_Entry Repeat(DataDriverEntry value, int count) {
    global::System.IntPtr cPtr = chrono_vehiclePINVOKE.vector_Entry_Repeat(DataDriverEntry.getCPtr(value), count);
    vector_Entry ret = (cPtr == global::System.IntPtr.Zero) ? null : new vector_Entry(cPtr, true);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    chrono_vehiclePINVOKE.vector_Entry_Reverse__SWIG_0(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    chrono_vehiclePINVOKE.vector_Entry_Reverse__SWIG_1(swigCPtr, index, count);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, vector_Entry values) {
    chrono_vehiclePINVOKE.vector_Entry_SetRange(swigCPtr, index, vector_Entry.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
