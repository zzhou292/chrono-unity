...
public class AddContactCallback : global::System.IDisposable {
    ...
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwnBase) {
          ...
          chronoPINVOKE.delete_AddContactCallback(swigCPtr);
        }
  ...
  public virtual void OnAddContact(ChCollisionInfo contactinfo, ChContactMaterialComposite material) {
    chronoPINVOKE.AddContactCallback_OnAddContact(swigCPtr, ChCollisionInfo.getCPtr(contactinfo), ChContactMaterialComposite.getCPtr(material));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public AddContactCallback() : this(chronoPINVOKE.new_AddContactCallback(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    chronoPINVOKE.AddContactCallback_director_connect(swigCPtr, swigDelegate0);
  }
  ...
  private void SwigDirectorMethodOnAddContact(global::System.IntPtr contactinfo, global::System.IntPtr material) {
    OnAddContact(new ChCollisionInfo(contactinfo, false), (material == global::System.IntPtr.Zero) ? null : new ChContactMaterialComposite(material, true));
  }
  ...
  private static global::System.Type[] swigMethodTypes0 = new global::System.Type[] { typeof(ChCollisionInfo), typeof(ChContactMaterialComposite) };
}
