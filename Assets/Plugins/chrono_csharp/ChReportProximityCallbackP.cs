...
public class ChReportProximityCallbackP : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          chronoPINVOKE.delete_ChReportProximityCallbackP(swigCPtr);
        }
  ...
  public virtual bool OnReportProximity(ChCollisionModel modA, ChCollisionModel modB) {
    bool ret = (SwigDerivedClassHasMethod("OnReportProximity", swigMethodTypes0) ? chronoPINVOKE.ChReportProximityCallbackP_OnReportProximitySwigExplicitChReportProximityCallbackP(swigCPtr, ChCollisionModel.getCPtr(modA), ChCollisionModel.getCPtr(modB)) : chronoPINVOKE.ChReportProximityCallbackP_OnReportProximity(swigCPtr, ChCollisionModel.getCPtr(modA), ChCollisionModel.getCPtr(modB)));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public ChReportProximityCallbackP() : this(chronoPINVOKE.new_ChReportProximityCallbackP(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    chronoPINVOKE.ChReportProximityCallbackP_director_connect(swigCPtr, swigDelegate0);
  }
