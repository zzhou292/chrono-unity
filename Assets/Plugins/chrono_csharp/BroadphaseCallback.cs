...
public class BroadphaseCallback : global::System.IDisposable {
    ...
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwnBase) {
          ...
          chronoPINVOKE.delete_BroadphaseCallback(swigCPtr);
        }
  ...
  public virtual bool OnBroadphase(ChCollisionModel modelA, ChCollisionModel modelB) {
    bool ret = chronoPINVOKE.BroadphaseCallback_OnBroadphase(swigCPtr, ChCollisionModel.getCPtr(modelA), ChCollisionModel.getCPtr(modelB));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public BroadphaseCallback() : this(chronoPINVOKE.new_BroadphaseCallback(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    chronoPINVOKE.BroadphaseCallback_director_connect(swigCPtr, swigDelegate0);
  }
