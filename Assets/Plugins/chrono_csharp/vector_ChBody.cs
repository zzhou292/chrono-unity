...
public class vector_ChBody : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<ChBody>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          chronoPINVOKE.delete_vector_ChBody(swigCPtr);
        }
  ...
  public void Clear() {
    chronoPINVOKE.vector_ChBody_Clear(swigCPtr);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(ChBody x) {
    chronoPINVOKE.vector_ChBody_Add(swigCPtr, ChBody.getCPtr(x));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = chronoPINVOKE.vector_ChBody_size(swigCPtr);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = chronoPINVOKE.vector_ChBody_capacity(swigCPtr);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    chronoPINVOKE.vector_ChBody_reserve(swigCPtr, n);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_ChBody() : this(chronoPINVOKE.new_vector_ChBody__SWIG_0(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_ChBody(vector_ChBody other) : this(chronoPINVOKE.new_vector_ChBody__SWIG_1(vector_ChBody.getCPtr(other)), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_ChBody(int capacity) : this(chronoPINVOKE.new_vector_ChBody__SWIG_2(capacity), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  private ChBody getitemcopy(int index) {
    global::System.IntPtr cPtr = chronoPINVOKE.vector_ChBody_getitemcopy(swigCPtr, index);
  ...
  private ChBody getitem(int index) {
    global::System.IntPtr cPtr = chronoPINVOKE.vector_ChBody_getitem(swigCPtr, index);
    ChBody ret = (cPtr == global::System.IntPtr.Zero) ? null : new ChBody(cPtr, true);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private void setitem(int index, ChBody val) {
    chronoPINVOKE.vector_ChBody_setitem(swigCPtr, index, ChBody.getCPtr(val));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(vector_ChBody values) {
    chronoPINVOKE.vector_ChBody_AddRange(swigCPtr, vector_ChBody.getCPtr(values));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public vector_ChBody GetRange(int index, int count) {
    global::System.IntPtr cPtr = chronoPINVOKE.vector_ChBody_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, ChBody x) {
    chronoPINVOKE.vector_ChBody_Insert(swigCPtr, index, ChBody.getCPtr(x));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, vector_ChBody values) {
    chronoPINVOKE.vector_ChBody_InsertRange(swigCPtr, index, vector_ChBody.getCPtr(values));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    chronoPINVOKE.vector_ChBody_RemoveAt(swigCPtr, index);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    chronoPINVOKE.vector_ChBody_RemoveRange(swigCPtr, index, count);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public static vector_ChBody Repeat(ChBody value, int count) {
    global::System.IntPtr cPtr = chronoPINVOKE.vector_ChBody_Repeat(ChBody.getCPtr(value), count);
    vector_ChBody ret = (cPtr == global::System.IntPtr.Zero) ? null : new vector_ChBody(cPtr, true);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    chronoPINVOKE.vector_ChBody_Reverse__SWIG_0(swigCPtr);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    chronoPINVOKE.vector_ChBody_Reverse__SWIG_1(swigCPtr, index, count);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, vector_ChBody values) {
    chronoPINVOKE.vector_ChBody_SetRange(swigCPtr, index, vector_ChBody.getCPtr(values));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }
