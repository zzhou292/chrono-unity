...
public class int_ptr : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          chronoPINVOKE.delete_int_ptr(swigCPtr);
        }
  ...
  public int_ptr() : this(chronoPINVOKE.new_int_ptr(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void assign(int value) {
    chronoPINVOKE.int_ptr_assign(swigCPtr, value);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public int value() {
    int ret = chronoPINVOKE.int_ptr_value(swigCPtr);
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_int cast() {
    global::System.IntPtr cPtr = chronoPINVOKE.int_ptr_cast(swigCPtr);
  ...
  public static int_ptr frompointer(SWIGTYPE_p_int t) {
    global::System.IntPtr cPtr = chronoPINVOKE.int_ptr_frompointer(SWIGTYPE_p_int.getCPtr(t));
