...
public class NarrowphaseCallback : global::System.IDisposable {
    ...
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwnBase) {
          ...
          chronoPINVOKE.delete_NarrowphaseCallback(swigCPtr);
        }
  ...
  public virtual bool OnNarrowphase(ChCollisionInfo contactinfo) {
    bool ret = chronoPINVOKE.NarrowphaseCallback_OnNarrowphase(swigCPtr, ChCollisionInfo.getCPtr(contactinfo));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public NarrowphaseCallback() : this(chronoPINVOKE.new_NarrowphaseCallback(), true) {
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    chronoPINVOKE.NarrowphaseCallback_director_connect(swigCPtr, swigDelegate0);
  }
