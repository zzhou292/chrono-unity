...
public class WheelStates : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<WheelState>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          chrono_vehiclePINVOKE.delete_WheelStates(swigCPtr);
        }
  ...
  public void Clear() {
    chrono_vehiclePINVOKE.WheelStates_Clear(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(WheelState x) {
    chrono_vehiclePINVOKE.WheelStates_Add(swigCPtr, WheelState.getCPtr(x));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = chrono_vehiclePINVOKE.WheelStates_size(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = chrono_vehiclePINVOKE.WheelStates_capacity(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    chrono_vehiclePINVOKE.WheelStates_reserve(swigCPtr, n);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public WheelStates() : this(chrono_vehiclePINVOKE.new_WheelStates__SWIG_0(), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public WheelStates(WheelStates other) : this(chrono_vehiclePINVOKE.new_WheelStates__SWIG_1(WheelStates.getCPtr(other)), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public WheelStates(int capacity) : this(chrono_vehiclePINVOKE.new_WheelStates__SWIG_2(capacity), true) {
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  private WheelState getitemcopy(int index) {
    WheelState ret = new WheelState(chrono_vehiclePINVOKE.WheelStates_getitemcopy(swigCPtr, index), true);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private WheelState getitem(int index) {
    WheelState ret = new WheelState(chrono_vehiclePINVOKE.WheelStates_getitem(swigCPtr, index), false);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, WheelState val) {
    chrono_vehiclePINVOKE.WheelStates_setitem(swigCPtr, index, WheelState.getCPtr(val));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(WheelStates values) {
    chrono_vehiclePINVOKE.WheelStates_AddRange(swigCPtr, WheelStates.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public WheelStates GetRange(int index, int count) {
    global::System.IntPtr cPtr = chrono_vehiclePINVOKE.WheelStates_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, WheelState x) {
    chrono_vehiclePINVOKE.WheelStates_Insert(swigCPtr, index, WheelState.getCPtr(x));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, WheelStates values) {
    chrono_vehiclePINVOKE.WheelStates_InsertRange(swigCPtr, index, WheelStates.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    chrono_vehiclePINVOKE.WheelStates_RemoveAt(swigCPtr, index);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    chrono_vehiclePINVOKE.WheelStates_RemoveRange(swigCPtr, index, count);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public static WheelStates Repeat(WheelState value, int count) {
    global::System.IntPtr cPtr = chrono_vehiclePINVOKE.WheelStates_Repeat(WheelState.getCPtr(value), count);
    WheelStates ret = (cPtr == global::System.IntPtr.Zero) ? null : new WheelStates(cPtr, true);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    chrono_vehiclePINVOKE.WheelStates_Reverse__SWIG_0(swigCPtr);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    chrono_vehiclePINVOKE.WheelStates_Reverse__SWIG_1(swigCPtr, index, count);
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, WheelStates values) {
    chrono_vehiclePINVOKE.WheelStates_SetRange(swigCPtr, index, WheelStates.getCPtr(values));
    if (chrono_vehiclePINVOKE.SWIGPendingException.Pending) throw chrono_vehiclePINVOKE.SWIGPendingException.Retrieve();
  }
