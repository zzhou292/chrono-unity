...
public class ChParticleEventTrigger : global::System.IDisposable {
    ...
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwnBase) {
          ...
          chronoPINVOKE.delete_ChParticleEventTrigger(swigCPtr);
        }
  ...
  public virtual bool TriggerEvent(ChBody mbody, ChSystem msystem) {
    bool ret = chronoPINVOKE.ChParticleEventTrigger_TriggerEvent(swigCPtr, ChBody.getCPtr(mbody), ChSystem.getCPtr(msystem));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual void SetupPreProcess(ChSystem msystem) {
    chronoPINVOKE.ChParticleEventTrigger_SetupPreProcess(swigCPtr, ChSystem.getCPtr(msystem));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void SetupPostProcess(ChSystem msystem) {
    chronoPINVOKE.ChParticleEventTrigger_SetupPostProcess(swigCPtr, ChSystem.getCPtr(msystem));
    if (chronoPINVOKE.SWIGPendingException.Pending) throw chronoPINVOKE.SWIGPendingException.Retrieve();
  }
